...
if(isset($_POST['guardar'])){
    ...
    if($validador->entrada_valida()){
        ...
        if(ControlSesion::sesion_iniciada()){
            ...
            $entrada=new Entrada('',$_SESSION['id_usuario'],$validador->obtener_url(),$validador->obtener_titulo(),$validador->obtener_texto(),'',
                    $entrada_publica);
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <form class="form-nueva-entrada" method="post" action="<?php RUTA_NUEVA_ENTRADA ; ?>  ">
